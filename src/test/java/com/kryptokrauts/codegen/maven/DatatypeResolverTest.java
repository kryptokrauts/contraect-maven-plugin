...
public class DatatypeResolverTest extends BaseTest {
	...
	public void testInputOutput() throws Exception {
		...
		// custom types
		ioTestMap.put("testCompanyAddress",
				getCustomTypeInstance("companyAddress",
						Arrays.asList(BigInteger.class, String.class,
								String.class),
						BigInteger.valueOf(42), "street", "city"));
		Object addressInstance = getCustomTypeInstance("address",
				Arrays.asList(String.class),
				"ak_2gx9MEFxKvY9vMG5YnqnXWv1hCsX7rgnfvBLJS4aQurustR1rt");
		ioTestMap.put("testAddress", addressInstance);
		ioTestMap.put("testEmployee",
				getCustomTypeInstance("employee",
						Arrays.asList(getCustomTypeClass("Address"),
								String.class, String.class),
						addressInstance, "firstName", "lastName"));
	...
	private Object getCustomTypeInstance(String customTypeName,
			List<Class<?>> constructorValuesClasses,
			Object... constructorValues) throws Exception {
		return Class
				.forName(targetPackage + "." + datatypeTestClassName + "$"
						+ CodegenUtil.getUppercaseClassName(customTypeName))
				.getConstructor(constructorValuesClasses
						.toArray(new Class[constructorValuesClasses.size()]))
				.newInstance(constructorValues);
	}

	private Class<?> getCustomTypeClass(String name)
			throws ClassNotFoundException {
		return Class.forName(
				targetPackage + "." + datatypeTestClassName + "$" + name);
	}
}
