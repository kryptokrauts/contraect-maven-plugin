...
public abstract class AbstractDatatypeMapper implements DatatypeMapper {
	...
	protected static final TypeName LIST_WITH_WILDCARD_TYPDEF = ParameterizedTypeName
			.get(ClassName.get(List.class),
					WildcardTypeName.subtypeOf(Object.class));

	@NonNull
	protected DatatypeMappingHandler resolveInstance;
	...
	protected String getUniqueVariableName(String variableName) {
		return "_" + variableName.replaceAll("\\.", "_").replaceAll("\\(", "_")
