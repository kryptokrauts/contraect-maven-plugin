...
public class ContraectCodegenMojo extends AbstractMojo {
  ...
  @Parameter(defaultValue = "com.kryptokrauts.generated.contraect")
  private String targetPackage;

  /** The package for autogenerated sophia datatypes */
  @Parameter(defaultValue = "com.kryptokrauts.generated.contraect.datatypes")
  private String datatypePackage;

  /** The path where generated contracts are created */
  @Parameter(defaultValue = "target/generated-sources/contraect")
  ...
  @Parameter private ABIJsonDescription abiJsonDescription;
  ...
  private void logFiles(List<String> aesFiles) {
    if (aesFiles.size() > 0) {
      getLog().debug(String.format("Found %d contracts for generation", aesFiles.size()));
      aesFiles.forEach(
          c -> {
            getLog().debug(c);
          });
